      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-gray-400 hover:text-primary-400 transition text-sm">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="mt-14 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-gray-500 text-sm">
            <Link href="/contact" className="hover:text-primary-400 transition">Privacy</Link>
            <Link href="/contact" className="hover:text-primary-400 transition">Terms</Link>
          </div>
        </div>
      </div>
    </footer>
